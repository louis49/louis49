...
- **[lego-emcom](https://github.com/louis49/lego-emcom)** - Emergent communication framework for 3D structure reconstruction. Two neural agents learn to communicate about colored LEGO structures through a discrete channel -- no pre-defined language, no supervision on messages. 3D CNN encoder/decoder, Gumbel-Softmax channel. PyTorch. Paper in preparation.
